...
static CGFloat const lz_contentHeight = 286.0;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.titleAttributes = @{NSFontAttributeName:[UIFont systemFontOfSize:14],NSForegroundColorAttributeName:VAMainTitleColor};
        self.textAttributes = @{NSFontAttributeName:[UIFont systemFontOfSize:14],NSForegroundColorAttributeName:VAMainTitleColor};
